...
|----------|------|-------------|---------------------|----------|
| SyndicateFactory | `0xAC74EC56858d7F1f7618c8e77F65Fc26aDf33c82` | `0x121AaC2B96Ec365e457fcCc1C2ED5a6142064069` | `0x6d026e2f5Ff0C34A01690EC46Cb601B8fF391985` | `0xd05Ae0E8bcf13075C29817c805d6Cc14F214393a` |
| SyndicateGovernor | `0x9Fd3c87B34F254e3c5652A0394B9780c2F05d367` | `0xE5ecf2B06E3f3e298B632C0cf6575f9d9422F55E` | `0xd882056ba6b0aEd8908c541884B327121E2f2C9C` | `0x67AD3D5F3d127Ef923Fd6f67b178633c408D3fd3` |
| GuardianRegistry | `0x49E4163b5e4b23F8f3d469Cf6fa197FB6b06A26E` | — | — | `0x8b5710EB4e2fA639F364Dcc3F3B30c8f12F460b9` |
| BatchExecutorLib | `0xbC79FbD5036C1Cc4A9d10BDf8628BF09a558496E` | `0x847758DDb37F1709da5bB3d3F8aC395938e6a84f` | `0x1493f5a7E5d82e1e56c34e2Ba300f56F97186017` | `0x2c454bEF1b09c8a306a7058b8B510bF0DfF7179D` |
| SyndicateVaultImpl | `0xfce4bcE08E9C047E4736f75C2B8557e2754Ce36A` | — | `0xF4720523325f9A4546F43391484DCd1D28dFc266` | `0x2cbBe36Cf907A2BB410bacB0e4Fd632C7b012846` |
...
V1 templates (below) do not implement `IStrategy.onLiveDeposit` introduced in V1.5 and therefore cannot be cloned against the new V1.5 factory `0xAC74…3c82`. They remain on-chain for in-flight settle-out only. V1.5 Base templates pending redeploy.

| Template | V1 address (settle-out only) |
|----------|------------------------------|
...
| Template | Address |
|----------|---------|
| HyperliquidPerpStrategy | `0x4435Aae199907f60588902Bcd7c4363a13Bb2951` |
| HyperliquidGridStrategy | `0xa07b86234582a327C2DCCf41d603fBcb24aE3448` |
